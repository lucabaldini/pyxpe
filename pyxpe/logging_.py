...
logger = logging.getLogger('pyxpe')
...
class xpeFileFormatter(logging.Formatter):
...
class xpeFileHandler(logging.FileHandler):
    ...
    def __init__(self, filePath, mode = 'a', encoding = None, delay = False):
        ...
        self.setFormatter(xpeFileFormatter())
...
def startmsg():
    ...
    """
    from pyxpe.__version__ import TAG, BUILD_DATE
    print('\n    Welcome to pyxpe %s (built on %s).\n' %\
              (TAG, BUILD_DATE))
    print('    Copyright (C) 2015--2016, the pyxpe team.\n\n    pyxpe comes with ABSOLUTELY NO WARRANTY.\n    This is free software, and you are welcome to redistribute it under certain\n    conditions. See the LICENSE file for details.\n\n    Visit https://github.com/lucabaldini/ximpol for more information.\n')
